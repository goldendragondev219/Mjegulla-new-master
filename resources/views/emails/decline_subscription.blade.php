                    ...
                    <tr>
                        <td style="padding: 25px 0; text-align: center;">
                          <a href="{{ url('/') }}" style="display: inline-block; text-decoration: none;">
                            <img src="https://mjegulla.com/home_assets/logo.png" style="position: relative; border: none; height: auto; width: auto; max-width: 120px !important;">
                          </a>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="font-family: Arial, &#039;Helvetica Neue&#039;, Helvetica, sans-serif; padding: 35px;">
                            ...
                            <h1 style="margin-top: 0; color: #2F3133; font-size: 19px; font-weight: bold; text-align: left;">
                              {{trans('emails.hello')}} {{ strstr($data['name'], ' ', true) }}
                            </h1>

                            <!-- Intro -->
                            <p style="margin-top: 0; color: #74787E; font-size: 16px; line-height: 1.5em;">
                               {{ trans('emails.subscription_decline_msg') }}
                            </p>
                            <p style="font-weight: 600;">{{ trans('emails.decline_stripe_message', ['message' => $data['message']]) }}</p>
                            <p style="color: #74787E; font-weight: bold; text-align: left;">{{ trans('emails.decline_after_call_message') }}</p>
                          </td>
                    </tr>
                </table>
            </td>

                    ...
                    <tr>
                        <td style="padding: 25px 0; text-align: center;">
                          <a href="{{ url('/') }}" style="display: inline-block; text-decoration: none;">
                            <img src="@if($type == 'owner') https://mjegulla.com/home_assets/logo.png @else{{ $data['shop']->shop_image_url }}@endif" style="position: relative; border: none; height: auto; width: auto; max-width: 120px !important;">
                          </a>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="font-family: Arial, &#039;Helvetica Neue&#039;, Helvetica, sans-serif; padding: 35px;">
                            ...
                            <h1 style="margin-top: 0; color: #2F3133; font-size: 19px; font-weight: bold; text-align: left;">
                              {{trans('emails.hello')}} {{$data['user']->name}}
                            </h1>

                            <!-- Intro -->
                            <p style="margin-top: 0; color: #74787E; font-size: 16px; line-height: 1.5em;">
                                @if($type == 'owner')
                                    {!! trans('emails.order_complete_message_seller', ['order_amount' => $data['order_amount']]) !!}
                                @else
                                    {!! trans('emails.order_complete_message_buyer', ['order_amount' => $data['order_amount']]) !!}
                                @endif
                            </p>
